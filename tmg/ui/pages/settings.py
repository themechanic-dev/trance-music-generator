...
class SettingsPage(Adw.PreferencesPage):
    ...
    def _build_library(self) -> None:
        ...
        g.add(keep)
        vocals = Adw.SwitchRow(title="Extract spoken phrases into the phrase bank", subtitle="Spoken lines found in the vocals stem by the speech rule (gaps between syllables, consonants and vowels, voice band, no beat-locked pulsing), tagged 'library'")
        ...
        vthr.set_subtitle("Activity floor in the vocals stem; lower = quieter stretches are considered too. The speech rule decides what is kept")
